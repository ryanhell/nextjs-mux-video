        ...
        <div className="tables min-h-screen" >
            <div className="relative h-96 md:h-[500px] lg:h-[600px] overflow-hidden">
                <div style={{ width: '100%', height: '100%', position: 'relative' }}>
                    ...
                    />
                    <figcaption style={{ textAlign: 'center', color: 'red' }}>
                        efdefe
                    </figcaption>
                </div>
                <div className="relative z-10 h-full flex items-end">
                    <div className="w-full px-4 sm:px-6 lg:px-8 pb-8 md:pb-12">
                        <div className="max-w-7xl px-3mx-auto">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section>
                            <Card className="bg-black px-4">
                                <h1 className="text-7xl headlined">EXPOSED </h1>
                                <h2 className="text-3xl md:text-4xl font-bold text-slate-200 mb-6"> Rivercom 911{`'`}s "Operation Manager": Kidnapper, Truck Thief, Engaged in an Attempted Murder Involving RETIRED Law Maker and Chelan Sheriffs and Wenatchee Fire Department. </h2>
                                <h4 className="italic text-2xl text-white text-shadow-accent drop-shadow-xl">Sounds so crazy cant be true? Buckle up. Their own evidence clearly proves these accusations.</h4>
                                <div className="prose prose-lg max-w-none text-gray-700">
                                    ...
                                    <Card className="w-full text-center shadow-none dark mx-4 py-4">
                                        <CardHeader>
                                    ...
                                    <Card className="bg bg-red-900 to bg-blend-color-burn text-white px-7 mx-5">
                                        <CardHeader>
                                            <p className="text-4xl text-shadow-border">Not a good look at all for Rivercom 911; but true.</p>
                                        </CardHeader>
                                        <CardContent>

                                            <p className="text-2xl italic lead">"Rivercom 911 Operations Manager attempts to swat witness After denying them ambulance then kidnapping them during a  911 duress call for a diasabled person in valid, Grave Medical Need"</p>
                                            <p className="text-1x">My life is in grave danger and I do not want to expose anything; but it is my duty to; I habe an obligation to my fellow citizens because these people were engaged in a ruthless and well rehearsed type of conduct which it is apparent they have extensive experience with.</p>
                                            <h3 className="text-lead text-xl">As a private PSAP Rivercom is not only a financial endeavor for the politicos who own it; it is a tool to be used to exploit the bounds of civil rights, and justice, as they seem fit. </h3>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <Card className="px-10 mx-3 mb-3 inset-2 drop-shadow-2xl">
                                        <h4 className="text-3xl">Watch Jeremiahs Hate and Violence All For Trying to Call State Patrol!</h4>
                                        <p className="text-xl">
                                            ...
                                            Keep in mind I have not been to wenatchee since 2010. I dont know anyone there i can think of. THe 6 years I lived there I had one traffic stop, no valid license on purpose. I was a startup owner and I was a full time university student. Its wild to me anyone could hate me that much. I know a lot of people hate me, but this was next level. Threw their careers away and sunk a multi million dollar PSAP just because I have a ;lot wrong with me? What does that even mean? Because I havent been a fugative in over 5 YEARS. I have not been engaged in any criminal activity for DECADES.</p>

                                    </Card>
                                    <Card className="px-10 mx-3 inset-2 drop-shadow-2xl">
                                        <p className="text-xl">
