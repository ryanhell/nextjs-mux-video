...
export default function Home() {
  return (
    <div className="py-6">
      ...
      <p className="text-3xl">The sheer volume of discrepencioes and unaddressed detaails like what the hell was a retired former 20 year CHIEF prosecutor from Seattke doing runninj out the back door so to speak, of these scumbag corrupt city worjkers home?</p>
      ...
      <Card className="bg-black text-white">
        ...
        <CardContent>
          <ul>
            ...
            <Image src="/Chelan/july4_2024/towtruck.jpg" width="1400" height="2800" alt="This is a photp of the tow and operator at the scene. Stans Mountain View or whatever never existed"></Image>
