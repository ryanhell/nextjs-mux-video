                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <section>
                            ...
                            <div className="prose prose-lg max-w-none text-gray-700">
                                ...
                                <p className="leading-relaxed mb-6">
                                    There are a lot of nuances and details I will eventually highlight which will prove these kidnapping dispatchers were not just confident; they were extremely experienced with the entire procedure. This was a thing they had done many times I could tell.The fact I survived is nothing short of a miracle. And I am well aware that it is not over yet.
                                </p>
